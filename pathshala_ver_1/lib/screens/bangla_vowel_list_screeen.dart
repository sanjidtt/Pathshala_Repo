...
class BanglaVowelListScreen extends StatefulWidget {
  static String id = 'bangla_vowel_list_screen';
  @override
  _BanglaVowelListScreenState createState() => _BanglaVowelListScreenState();
}

class _BanglaVowelListScreenState extends State<BanglaVowelListScreen> {
  @override
